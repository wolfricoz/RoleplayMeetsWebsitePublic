...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $permissions = ['access_dashboard', 'ban_users','manage_posts', 'manage_users', 'manage_rules', 'manage_genres', 'manage_groups', 'manage_roles', 'manage_settings', 'is_patron', 'create_posts', 'edit_posts', 'delete_posts', 'hide_adverts'];
        ...
        $role->givePermissionTo(['access_dashboard','manage_posts', 'manage_users', 'is_patron', 'create_posts', 'edit_posts', 'delete_posts', 'hide_adverts']);

        $role = Role::findByName('Patron');
        $role->givePermissionTo(['is_patron', 'create_posts', 'edit_posts', 'delete_posts', 'hide_adverts']);

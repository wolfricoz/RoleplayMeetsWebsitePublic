<template>
  <div class="tags w-full rounded-xl">
    <input type="hidden" :value="selected_values" :name="name" />
    <Multiselect
      :classes="{
        //These have been edited.
        container:
          'tags rounded-xl relative mx-auto w-full flex items-center justify-end box-border cursor-pointer rounded bg-white text-base leading-snug outline-none dark:bg-gray-600 dark:text-gray-200 h-fit lg:h-9',
        wrapper:
          'tags rounded-xl relative mx-auto w-full flex items-center justify-end box-border cursor-pointer outline-none dark:bg-gray-600 dark:text-gray-200 h-fit lg:h- ', // this is part of the background.
        ...
        singleLabel:
          'flex items-center h-full max-w-full absolute left-0 top-0 pointer-events-none  leading-snug pl-3.5 pr-16 box-border rtl:left-auto rtl:right-0 rtl:pl-0 rtl:pr-3.5 dark:hover:bg-gray-500',
        singleLabelText:
        ...
        tagsSearch:
          ' absolute inset-0 border-0 outline-none focus:ring-0 appearance-none p-0 text-base font-sans box-border w-full dark:bg-gray-500 dark:text-gray-200',
        ...
        dropdown:
          'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full border border-gray-300 -mt-px overflow-y-scroll z-50 bg-white flex flex-col rounded-b dark:bg-gray-600',
        dropdownTop:
        ...
        optionPointed:
          'text-gray-800 bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-blue-400 dark:bg-gray-600',
        optionSelected:
          'text-white bg-green-500 dark:hover:bg-gray-500 dark:hover:text-blue-400 dark:bg-gray-600',
        optionDisabled: 'text-gray-300 cursor-not-allowed',
        optionSelectedPointed:
          'text-white bg-green-500 opacity-90 dark:hover:bg-gray-500 dark:hover:text-blue-400 dark:bg-gray-600',

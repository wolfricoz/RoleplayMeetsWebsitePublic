<x-admin-layout.header>
    <div id="app" class="m-5 rounded-xl bg-gray-100 p-4">
        <div class="grid grid-cols-4 gap-4">
            <div
                class="col-span-4 grid grid-cols-3 gap-4 border-b border-gray-300"
            >
                    ...
                    >
                        <div class="flex flex-row p-1">
                            ...
                            <div class="w-full p-2 text-sm">
                                ...
                                <h6
                                    class="border-b border-gray-300 text-center text-xs"
                                >
                                    {{ $user->username }}
                                </h6>
                                @isset($user->banned_at)
                                    <div
                                        class="rounded-xl bg-red-500 p-1 text-white"
                                    >
                                        <h1

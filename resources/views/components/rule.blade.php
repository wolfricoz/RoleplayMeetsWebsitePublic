<div
  class="w-full rounded-xl border border-gray-200 bg-gray-100"
  x-data="{ display: true }"
>
  <div
    class="flex flex-row justify-between rounded-xl bg-gray-200 p-2 hover:cursor-pointer hover:bg-gray-300"

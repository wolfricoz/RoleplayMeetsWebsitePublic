<x-layout.header>
  <div id="app" class="m-12 grid grid-cols-1 gap-4" x-data="">
    <div
      class="col-span-1 rounded-xl bg-gray-100 p-12 text-center dark:bg-gray-700 dark:text-gray-200 space-y-3"
    >
      <p>

      <h1 class="text-center text-3xl font-bold ">TERMS OF SERVICE</h1>
      <h6 class="text-center border-b border-gray-200">Last updated March 30, 2024</h6>
      <h6 class="text-center text-lg">Agreement to our legal terms</h6>
      <article class="text-left space-y-5">
        <p>
          We are Roleplay Meets ("Company," "we," "us," "our"), a company registered in the Netherlands.
        </p>
        <p>
          We operate the website http://www.roleplaymeets.com (the "Site"), as well as any other related products and
          services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          We provide an online space for users to advertise themselves and find other users to collaboratively write and
          roleplay.
        </p>
        <p>
          You can contact us by email at <a href="mailto:rico@roleplaymeets.com">rico@roleplaymeets.com</a> or by mail
          to Sas, Ricardo, Netherlands.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of
          an entity ("you"), and Roleplay Meets, concerning your access to and use of the Services. You agree that by
        ...
        <p>
          ...
          Legal Terms will become effective upon posting or notifying you by support@roleplaymeets.com, as stated in the
      ...
      <h3 class="text-center text-lg font-bold">TABLE OF CONTENTS</h3>
      <ol class="p-6 text-left list-decimal">
        <li><a href="#services" class="hover:text-blue-400 hover:underline">OUR SERVICES</a></li>
        <li><a href="#intellectual-property-rights" class="hover:text-blue-400 hover:underline">INTELLECTUAL PROPERTY RIGHTS</a></li>
        <li><a href="#user-representations" class="hover:text-blue-400 hover:underline">USER REPRESENTATIONS</a></li>
        <li><a href="#user-registration" class="hover:text-blue-400 hover:underline">USER REGISTRATION</a></li>
        <li><a href="#prohibited-activities" class="hover:text-blue-400 hover:underline">PROHIBITED ACTIVITIES</a></li>
        <li><a href="#user-generated-contributions" class="hover:text-blue-400 hover:underline">USER GENERATED CONTRIBUTIONS</a></li>
        <li><a href="#contribution-license" class="hover:text-blue-400 hover:underline">CONTRIBUTION LICENSE</a></li>
        <li><a href="#social-media" class="hover:text-blue-400 hover:underline">SOCIAL MEDIA</a></li>
        <li><a href="#third-party-websites-and-content" class="hover:text-blue-400 hover:underline">THIRD-PARTY WEBSITES AND CONTENT</a></li>
        <li><a href="#advertisers" class="hover:text-blue-400 hover:underline">ADVERTISERS</a></li>
        <li><a href="#services-management" class="hover:text-blue-400 hover:underline">SERVICES MANAGEMENT</a></li>
        <li><a href="#privacy-policy" class="hover:text-blue-400 hover:underline">PRIVACY POLICY</a></li>
        <li><a href="#copyright-infringements" class="hover:text-blue-400 hover:underline">COPYRIGHT INFRINGEMENTS</a></li>
        <li><a href="#modifications-and-interruptions" class="hover:text-blue-400 hover:underline">MODIFICATIONS AND INTERRUPTIONS</a></li>
        <li><a href="#governing-law" class="hover:text-blue-400 hover:underline">GOVERNING LAW</a></li>
        <li><a href="#dispute-resolution" class="hover:text-blue-400 hover:underline">DISPUTE RESOLUTION</a></li>
        <li><a href="#corrections" class="hover:text-blue-400 hover:underline">CORRECTIONS</a></li>
        <li><a href="#disclaimer" class="hover:text-blue-400 hover:underline">DISCLAIMER</a></li>
        <li><a href="#limitations-of-liability" class="hover:text-blue-400 hover:underline">LIMITATIONS OF LIABILITY</a></li>
        <li><a href="#indemnification" class="hover:text-blue-400 hover:underline">INDEMNIFICATION</a></li>
        <li><a href="#user-data" class="hover:text-blue-400 hover:underline">USER DATA</a></li>
        <li><a href="#electronic-communications-transactions-and-signatures" class="hover:text-blue-400 hover:underline">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
        <li><a href="#california-users-and-residents" class="hover:text-blue-400 hover:underline">CALIFORNIA USERS AND RESIDENTS</a></li>
        <li><a href="#miscellaneous" class="hover:text-blue-400 hover:underline">MISCELLANEOUS</a></li>
        <li><a href="#contact-us" class="hover:text-blue-400 hover:underline">CONTACT US</a></li>
      </ol>
      ...
      >2. INTELLECTUAL PROPERTY RIGHTS</h3>
      <article class="text-left space-y-5">
        <p>
        ...
        <p>
          access the Services; and download or print a copy of any portion of the Content to which you have properly
          gained access.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="mailto:rico@roleplaymeets.com">
            rico@roleplaymeets.com
          </a> If we ever grant you the permission to
        ...
        <p>
          ...
          about
          the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission.
          You
        ...
        <p>
          ...
          sell,
          resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt
          (in
          whole or in part), and exploit your Contributions (including, without limitation, your image, name, and voice)
          for
          any purpose, commercial, advertising, or otherwise, to prepare derivative works of, or incorporate into other
          works, your Contributions, and to sublicense the licenses granted in this section. Our use and distribution
          may
        ...
        <p>
          ...
          harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, false,
      ...
      <article class="text-left space-y-5">
        ...
        <ul class="text-left list-disc ml-5">
      ...
      >6. USER GENERATED CONTRIBUTIONS</h3>
      <article class="text-left space-y-5">
        <p>
          ...
          material (collectively, "Contributions"). Contributions may be viewable by other users of the Services and
          through
        ...
        <ul class="text-left list-disc ml-5">
          <li>The creation, distribution, transmission, public display, or performance, and the accessing, downloading,
            or
      ...
      <article class="text-left space-y-5">
        ...
        <p>
          ...
          liable
          for any statements or representations in your Contributions provided by you in any area on the Services. You
          are
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          govern
          your use of the applicable Third-Party Account, and without obligating us to pay any fees or making us subject
          to
          ...
          Content") so that it is available on and through the Services via your account, including without limitation
          any
          ...
          access
          to such Third-Party Account is terminated by the third-party service provider, then Social Network Content may
          no
          ...
          AGREEMENT(S)
          WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social Network Content for any
          purpose,
          ...
          Third-Party Account and your contacts list stored on your mobile device or tablet computer solely for purposes
          of
          identifying and informing you of those contacts who have also registered to use the Services. You can
          deactivate
          the connection between the Services and your Third-Party Account by contacting us using the contact
          information
      ...
      >9. THIRD-PARTY WEBSITES AND CONTENT</h3>
      <article class="text-left space-y-5">
        <p>
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          content
          that are excessive in size or are in any way burdensome to our systems; and (5) otherwise manage the Services
          in a
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          posted
          or stored the material addressed in the Notification. Please be advised that pursuant to applicable law you
          may be
          held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure
          that
      ...
      >15. MODIFICATIONS AND INTERRUPTIONS</h3>
      <article class="text-left space-y-5">
        <p>
        ...
        <p>
          ...
          errors. We
          reserve the right to change, revise, update, suspend, discontinue, or otherwise modify the Services at any
          time or
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          obligatory provisions of the law in your country to residence. Roleplay Meets and yourself both agree to
          submit to
          the non-exclusive jurisdiction of the courts of Noord-Brabant, which means that you may make a claim to defend
          your consumer protection rights in regards to these Legal Terms in the Netherlands, or in the EU country in
          which
          you reside.
        </p>
      </article>
      ...
      <article class="text-left space-y-5">
        ...
        <p>
          ...
          acceptance.
          The seat of arbitration shall be Breda, Netherlands. The language of the proceedings shall be English.
          Applicable
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          RESULTING
          FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
          AND/OR
          ...
          TRANSMITTED
          TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS
          OR
          FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR
          OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR
          ANY
      ...
      >20. LIMITATIONS OF LIABILITY</h3>
      <article class="text-left space-y-5">
        <p>
          ...
          THE
          AMOUNT PAID, IF ANY, BY YOU TO US OR $100.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          party,
          including but not limited to intellectual property rights; or (6) any overt harmful act toward any other user
          of
      ...
      >23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
      <article class="text-left space-y-5">
        <p>
      ...
      >24. CALIFORNIA USERS AND RESIDENTS</h3>
      <article class="text-left space-y-5">
        <p>
      ...
      <article class="text-left space-y-5">
        <p>
          ...
          them. You hereby waive any and all defenses you may have based on the electronic form of these Legal Terms and
          the

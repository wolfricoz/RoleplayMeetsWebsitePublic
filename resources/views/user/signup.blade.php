        ...
        <div class="flex flex-col lg:w-1/2">
            ...
            >
                <div class="border-b border-gray-200">
                    ...
                    <h6 class="text-center text-sm">
                        This will remove your account and all your data from the
                        site.
                    </h6>
                </div>
                <form
                ...
                >
                    ...
                    <p class="text-sm font-bold text-red-500">
                        * Upon receipt of a delete request, roleplaymeets.com
                        reserves the right to retain your data for up to 30 days
                        for processing of the deletion. During this 30-day
                        processing period, your account, posts, and other
                        personal information will not be accessible. If you wish
                        to cancel your deletion request, you may log in to
                        roleplaymeets.com at any time during the 30-day
                        processing period, which will cancel the processing and
                        restore your account to full functionality.
                    </p>
                </form>
            </div>
        </div>

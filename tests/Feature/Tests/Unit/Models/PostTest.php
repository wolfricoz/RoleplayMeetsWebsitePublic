...
class PostTest extends TestCase
{
    ...
    public function test_posts_can_be_filtered_by_genre(): void
    {
        ...
        $post1 = Post::factory()->create(['genre_id' => $genre->id]);
        $post2 = Post::factory()->create(['genre_id' => $genre->id]);
        $post3 = Post::factory()->create();

        $filteredPosts = Post::filter(['genre' => $genre->id])->get();
    ...
    public function test_post_belongs_to_a_genre(): void
    {
        ...
        $this->assertEquals($genre->id, $post->genre->id);
    }
